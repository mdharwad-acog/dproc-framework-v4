...
[![npm version](https://img.shields.io/npm/v/@aganitha/dproc-cli.svg)](https://npm.aganitha.ai/-/web/detail/@aganitha/dproc-cli)
...
- **Documentation:** [GitHub Wiki](https://github.com/mdharwad-acog/dproc-framework-v2/wiki)
- **Issues:** [GitHub Issues](https://github.com/mdharwad-acog/dproc-framework-v2/issues)
...
```bash
# Clone repository
git clone [https://github.com/mdharwad-acog/dproc-framework-v2.git](https://github.com/mdharwad-acog/dproc-framework-v2.git)
cd dproc-framework-v2
...
# Run locally
pnpm --filter dproc-cli start <command>
